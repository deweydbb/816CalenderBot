...
# from calenderBot.slack import send_volunteer_warning_message, send_special_note_message, send_message
# from calenderBot.config import * # yeah this is kinda awful but I don't feel like improving it with a real config file
